    ...
    return {
        template: `
            <g transform="translate(${x || cardDim.w - 20},${y || cardDim.h - 20})scale(.8)" style="cursor: pointer" class="card_edit pencil_icon">
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#FFFFFF" style="pointer-events: all;">
            ...
            <g class="card_add_relative">
                <g transform="translate(${x || cardDim.w / 2},${y || cardDim.h})scale(.13)">
                    ...
                    <g transform="translate(-10, -8)">
                        <line x1="10" x2="90" y1="50" y2="50" stroke="currentColor" stroke-width="15" stroke-linecap="round" />
                        <line x1="50" x2="50" y1="10" y2="90" stroke="currentColor" stroke-width="15" stroke-linecap="round" />
                    </g>
                </g>
            </g>
        `,
